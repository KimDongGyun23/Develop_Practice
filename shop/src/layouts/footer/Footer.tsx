    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.coupangInformation}>
        ...
        <div className={styles.paymentGuarantee}>
          ...
          <p>
            당사는 고객님이 현금 결제한 금액에 대해 우리은행과 채무지급보증 계약을 체결하여
            안전거래를 보장하고 있습니다.
          </p>
        </div>
      </div>
      ...
      <div className={styles.copyrightArea}>
        <div className={styles.copyrightAreaInner}>
          ...
          <div className={styles.copyright}>
            ...
            <span>
              마켓플레이스(오픈마켓) 상품의 경우 쿠팡은 통신판매중개자이며 통신판매의 당사자가
              아닙니다.
            </span>
            <span>
            ...
            <span>
              쿠팡은 소비자 보호와 안전거래를 위해 신뢰관리센터(CM112@coupang.com)를 운영하고
              있으며, 관련 분쟁이 발생할 경우 별도의 분쟁처리절차에 의거 분쟁이 처리됩니다.
            </span>
